...
L'évaluation précédente, conduite sur des images ne comportant qu'un seul visage bien cadré, mesure la qualité intrinsèque de la reconnaissance mais ne dit rien de la situation qui nous intéresse réellement : une salle où plusieurs personnes apparaissent en même temps, à des distances et sous des angles variés. Nous avons donc soumis le système à une seconde épreuve, plus proche de son usage. Faute de disposer, à ce stade, d'une photographie de notre promotion accompagnée des consentements nécessaires, nous avons reconstitué une scène multi-visages à partir de photographies publiques du jeu LFW : dix personnes ont été enrôlées comme s'il s'agissait des étudiants inscrits, puis rassemblées sur une même image aux côtés de deux individus non enrôlés jouant le rôle d'intrus. Les visages y figurent à des tailles différentes, certains légèrement inclinés, sur leurs arrière-plans d'origine.

Sur cette « photographie de classe », le moteur a détecté quatorze visages et reconnu sans aucune erreur les dix étudiants inscrits, tout en rejetant correctement les deux intrus, signalés comme « Inconnu ». Le traitement complet de l'image a demandé environ deux secondes sur un simple ordinateur portable. La figure 5.3 en donne le résultat annoté : chaque visage identifié est entouré et nommé, les inconnus étant nettement distingués des étudiants reconnus.

![Figure 5.3 — Reconnaissance sur une scène multi-visages reconstituée. Les dix étudiants inscrits sont reconnus et nommés (cadres verts) ; les deux intrus sont rejetés (« Inconnu »). Les deux cadres rouges sont des détections parasites, provoquées par des personnes présentes à l'arrière-plan de certaines photographies, et illustrent le bruit propre aux conditions non contrôlées.](diagrammes/fig_classe_annotee.png){ width=14cm }

Ce résultat appelle deux commentaires. D'un côté, il confirme que la chaîne fonctionne en situation multi-visages : la détection retrouve tous les visages présents, la reconnaissance attribue la bonne identité à chacun des étudiants, et le seuil écarte les personnes étrangères au groupe — exactement le comportement attendu d'une prise de présence. De l'autre, l'écart entre les douze visages réellement disposés et les quatorze détectés met en évidence une fragilité annoncée au paragraphe précédent : deux personnes visibles à l'arrière-plan de certaines photographies ont été prises pour des visages à part entière. En classe, ce type de bruit — silhouettes au fond de la salle, reflets, affiches — devra être filtré, et c'est précisément le rôle de la validation par l'enseignant, qui peut décocher en un geste une détection erronée avant l'enregistrement.

Ces observations restent celles d'un montage de visages publics, majoritairement de face ; elles ne se substituent pas à une validation sur une véritable photographie de classe, prise dans les conditions d'éclairage et de disposition d'une salle réelle. Cette confrontation au terrain, avec le consentement des personnes concernées, constitue la première des perspectives que nous traçons au chapitre suivant.
